...
const Contact: FC<ContactProps> = ({}) => {
  return (
    <div id="contato" className="flex flex-col gap-10 justify-center p-10 items-center w-full h-[600px] text-zinc-100 border-b-[0.5px] border-solid border-white">
      <h1 className="text-[45px] font-semibold tracking-wide">Entre em Contato!</h1>
      <div className="flex gap-[100px]">
        <div className="flex flex-col gap-4 justify-center items-center">
          ...
          <form className="flex flex-col gap-5" action="https://api.staticforms.xyz/submit" method="post">
