...
export default function handler(
  ...
  res.status(200).json([
    {
      id: 0,
      text: `Rafael Rocha é mutio técnico e estudioso dedicado.
    ...
    {
      id: 1,
      text: `Tive a oportunidade de trabalhar um projeto com o Rafael e a perícia dele com tecnologias
    ...
    {
      id: 2,
      text: `O Rafael é uma das minhas referências! Excelente desenvolvedor,
        fera no front-end e um ótimo colega de curso, sempre disposto a ajudar.
        Sou fã dos fronts dele! Recomendo muito.`
    },
    {
      id: 3,
      text: `Rafael Rocha é um excelente desenvolvedor, fortemente dedicado no seu
    ...
    {
      id: 4,
      text: `Rafael é um excelente programador, tecnicamente muito bom e dedicado.
        Recomendo fortemente ele para todas as empresas que desejam ter em seu quadro de colaboradores,
        um profissional que faz a diferença e contribui com os resultados positivos.`
    },
    {
      id: 5,
      text: `Se você procura alguém para front-end, ele é a pessoa certa.
        Bastante ágil e versátil, o Rochinha não vai descansar até ficar satisfeito com o
        resultado a ser entregue por ele.`
    },
    {
      id: 6,
      text: `Rafael é meu chará. Determinado e pró-ativo, busca sempre a melhor opção em seus desafios,
        é dedicado, compromoteido e sabe trabalhar em equipe.`
    },
    {
      id: 7,
      text: `Rafael é um otimo profissional, receptivo, atento, esforçado alem de ser cheio de vontade de crescer
        e se auto melhorar.`
    }
  ])
}
